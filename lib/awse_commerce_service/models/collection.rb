...
module AwseCommerceService
  ...
  class Collection < BaseModel
    ...
    def self.from_hash(hash)
      ...
      if hash['CollectionSummary']
        collection_summary = CollectionSummary.from_hash(hash['CollectionSummary'])
      end
      if hash['CollectionParent']
        collection_parent = CollectionParent.from_hash(hash['CollectionParent'])
      end
