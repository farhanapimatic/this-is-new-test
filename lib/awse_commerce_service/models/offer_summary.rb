...
module AwseCommerceService
  ...
  class OfferSummary < BaseModel
    ...
    def self.from_hash(hash)
      ...
      if hash['LowestCollectiblePrice']
        lowest_collectible_price = Price.from_hash(hash['LowestCollectiblePrice'])
      end
      if hash['LowestRefurbishedPrice']
        lowest_refurbished_price = Price.from_hash(hash['LowestRefurbishedPrice'])
      end
